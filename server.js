...
{ this.megista_grammata        =  (args && args.megista_grammata)?(+args.megista_grammata):50;
  ...
  { this.elaxista_grammata =  (args && args.elaxista_grammata)?+args.elaxista_grammata:1;
    this.lexh            =  (args.lexh)?args.lexh:'[a-zα-ω]';
...
{ //console.log( str )
  return str.replace( /[ABCDEFGHIGKLMNOPQRSTUVWXYZΑΆΒΓΔΕΈΖΗΉΘΙΊΪΚΛΜΝΞΟΌΠΡΣΤΥΎΫΦΧΨΩΏάέήίϊΐόύϋΰώς]/g, function (m) 
       { //console.log( '************************************' + m); 
         return { 'A':'a', 'B':'b', 'C':'c', 'D':'d', 'E':'e', 'F':'f', 'G':'g', 'H':'h', 
	 	  ...
	 	  'Ζ':'ζ', 'Η':'η', 'Ή':'η', 'Θ':'θ', 'Ι':'ι', 'Ί':'ι', 'Ϊ':'ι',
	 	  'Κ':'κ', 'Λ':'λ', 'Μ':'μ', 'Ν':'ν', 'Ξ':'ξ', 'Ο':'ο', 'Ό':'ο',
	 	  'Π':'π', 'Ρ':'ρ', 'Σ':'σ', 'Τ':'τ', 'Υ':'υ', 'Ύ':'υ', 'Ϋ':'υ',
	 	  'Φ':'φ', 'Χ':'χ', 'Ψ':'ψ', 'Ω':'ω', 'Ώ':'ω', 
	 	  'ά':'α', 'έ':'ε', 'ή':'η', 'ί':'ι', 'ϊ':'ι', 'ΐ':'ι', 
         	  'ό':'ο', 'ύ':'υ', 'ϋ':'υ', 'ΰ':'υ', 'ώ':'ω', 'ς':'σ', }[m]; }); }
